...
## [1.7.0](https://github.com/Namo2/streamystats/compare/v1.6.0...v1.7.0) (2025-04-28)
...
* arm build ([4e626bb](https://github.com/Namo2/streamystats/commit/4e626bb1bb88d2d20f808dc9c70181e081a8ba5a))
* arm build ([7f2bd5e](https://github.com/Namo2/streamystats/commit/7f2bd5ec8941078266acce564d6db9092d70ca44))
...
* import transcoding info when importing from jellystat ([8085ac9](https://github.com/Namo2/streamystats/commit/8085ac913aee9a3a84fd98b7623e67530b46e8b6))
...
* more stats ([3b3946b](https://github.com/Namo2/streamystats/commit/3b3946b2f8ab64d33cfef854c400cc06ad3fdd83))
...
* allow nil name by re-naming to "Untitled Item" ([dc2a8e3](https://github.com/Namo2/streamystats/commit/dc2a8e3c0fa544acf10a227dc2e88cbc4f318c2f))
* arm64 build error ([7be28fc](https://github.com/Namo2/streamystats/commit/7be28fc542c7971a445d7caf1e154e6a5c54c437))
* better docker image and entrypoint for the server ([3668560](https://github.com/Namo2/streamystats/commit/3668560cf83d8a97d6365f7ab701c152e07bf19b))
* better sync and cleanup ([229be4e](https://github.com/Namo2/streamystats/commit/229be4e607975483baca238db197af0a25503306))
* convert all string fields to text to prevent truncation errors ([ebdd46d](https://github.com/Namo2/streamystats/commit/ebdd46d0d675c86a3cbcf383599fd620eafcca9e))
* correct ids mapping from jellystat ([b55bea9](https://github.com/Namo2/streamystats/commit/b55bea911dfe41cde40551d100804332bc3591b7))
...
* delete and ignore duplicate playback session entries ([1a2f945](https://github.com/Namo2/streamystats/commit/1a2f9451626e9f21175fa9804b54e17d2c6e86c1))
* docs ([00a9bc5](https://github.com/Namo2/streamystats/commit/00a9bc5ec781dcf1ded779b5b32333430f541191))
* don't update version ([c002e26](https://github.com/Namo2/streamystats/commit/c002e264d8fdc0a2faf743b1305f1704319d0125))
* errors ([fa657b8](https://github.com/Namo2/streamystats/commit/fa657b85baccc266166d845e6a36f37c05ae8e4e))
* filter by type ([24ff630](https://github.com/Namo2/streamystats/commit/24ff6308a8ef04b36540fdd4890c79071dfe2f3f))
* handle large item requests + don't truncate text ([4e054bc](https://github.com/Namo2/streamystats/commit/4e054bc1a1986905ec6c81635422fb77f4742793))
...
* import error ([801d168](https://github.com/Namo2/streamystats/commit/801d168bd5829a4c0d778dfd3a36c32ad00d6fbb))
* improve jellyfin sync import by handling errors better ([e6bc339](https://github.com/Namo2/streamystats/commit/e6bc3390762b600a96881f213d6b11cc0b836f85))
* improve jellyfin sync reliability and error handling ([93c35cd](https://github.com/Namo2/streamystats/commit/93c35cd0e3e4cbf1eef9ffc3185c77f4eb6917ce))
* improve user watch streak calculation reliability ([e62c637](https://github.com/Namo2/streamystats/commit/e62c6371e06f7e95126e25b0c4e1b0b23157fe32))
* include season item statistics ([118a484](https://github.com/Namo2/streamystats/commit/118a48443084c0a8e903a97c5f30cac308256774))
* include tools version ([174f6f7](https://github.com/Namo2/streamystats/commit/174f6f72d4090744b1f297aadf425fc4235e6308))
* Prevent duplicate item conflicts during DB batch operations ([bda533a](https://github.com/Namo2/streamystats/commit/bda533a78d3129271153623dc63d5f836b3c64df))
...
* remove references to playback activities ([5a74bdd](https://github.com/Namo2/streamystats/commit/5a74bdd9c1cc5245afac881e116ac2ff658635fc))
* remove references to playback_activity ([a458363](https://github.com/Namo2/streamystats/commit/a4583633ab5d42167590bf6b31154f2794e17de2))
* run full sync on server create ([58b80c8](https://github.com/Namo2/streamystats/commit/58b80c85753c53ad0a6636c13b3896cb3de0afc5))
* sanitize name and ensure name is never null ([01729b4](https://github.com/Namo2/streamystats/commit/01729b44f1fe953aaa0ac37160dc2dd0c4d0047b))
* skip folders ([fc4c2e0](https://github.com/Namo2/streamystats/commit/fc4c2e0e62d0095a889cddb8a331c8220ac0e15b))
* specify on ([d62afdd](https://github.com/Namo2/streamystats/commit/d62afdd038bebb85ceb5fe41f0db458bf809840b))
* specify on ([e2b4d69](https://github.com/Namo2/streamystats/commit/e2b4d696ffef47589c0a0f329a0409851da56e38))
* start full sync when server starts ([5344abe](https://github.com/Namo2/streamystats/commit/5344abe8c2b993bd2dc9fe61c2ff307f5e335dd5))
* text longer than 255chars ([334ddc6](https://github.com/Namo2/streamystats/commit/334ddc6db68e60ae3013af9a85466f3312ae4d95))
* unused code ([baf1004](https://github.com/Namo2/streamystats/commit/baf100445e362ebc2b989941261617bdbda408f9))
* version ([92a0e96](https://github.com/Namo2/streamystats/commit/92a0e9648368e3450203e9d0f5f873a4b9b6f1fe))
* working ([1f9523b](https://github.com/Namo2/streamystats/commit/1f9523bf1048481c77cfef2e3ba95a0f8550b9a2))
